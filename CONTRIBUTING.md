...
Scope first. Check docs/status.md and open an issue before large
work. One interface or one layer per pull request.
...
tests/gdscript for runtime behavior. Update docs/status.md with the
honest state of anything touched.
