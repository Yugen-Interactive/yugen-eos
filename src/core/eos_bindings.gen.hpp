...
struct EOSApiTable {
    typedef EOS_EResult (EOS_CALL *EOS_Achievements_CopyAchievementDefinitionV2ByIndex_fn)(EOS_HAchievements Handle, const EOS_Achievements_CopyAchievementDefinitionV2ByIndexOptions* Options, EOS_Achievements_DefinitionV2 ** OutDefinition);
    typedef void (EOS_CALL *EOS_Achievements_DefinitionV2_Release_fn)(EOS_Achievements_DefinitionV2* AchievementDefinition);
    typedef uint32_t (EOS_CALL *EOS_Achievements_GetAchievementDefinitionCount_fn)(EOS_HAchievements Handle, const EOS_Achievements_GetAchievementDefinitionCountOptions* Options);
    typedef void (EOS_CALL *EOS_Achievements_QueryDefinitions_fn)(EOS_HAchievements Handle, const EOS_Achievements_QueryDefinitionsOptions* Options, void* ClientData, const EOS_Achievements_OnQueryDefinitionsCompleteCallback CompletionDelegate);
    ...
    typedef void (EOS_CALL *EOS_Auth_LinkAccount_fn)(EOS_HAuth Handle, const EOS_Auth_LinkAccountOptions* Options, void* ClientData, const EOS_Auth_OnLinkAccountCallback CompletionDelegate);
    ...
    typedef void (EOS_CALL *EOS_Connect_CreateUser_fn)(EOS_HConnect Handle, const EOS_Connect_CreateUserOptions* Options, void* ClientData, const EOS_Connect_OnCreateUserCallback CompletionDelegate);
    ...
    typedef void (EOS_CALL *EOS_CustomInvites_SendCustomInvite_fn)(EOS_HCustomInvites Handle, const EOS_CustomInvites_SendCustomInviteOptions* Options, void* ClientData, const EOS_CustomInvites_OnSendCustomInviteCallback CompletionDelegate);
    typedef EOS_EResult (EOS_CALL *EOS_CustomInvites_SetCustomInvite_fn)(EOS_HCustomInvites Handle, const EOS_CustomInvites_SetCustomInviteOptions* Options);
    ...
    typedef void (EOS_CALL *EOS_Friends_AcceptInvite_fn)(EOS_HFriends Handle, const EOS_Friends_AcceptInviteOptions* Options, void* ClientData, const EOS_Friends_OnAcceptInviteCallback CompletionDelegate);
    ...
    typedef void (EOS_CALL *EOS_Friends_RejectInvite_fn)(EOS_HFriends Handle, const EOS_Friends_RejectInviteOptions* Options, void* ClientData, const EOS_Friends_OnRejectInviteCallback CompletionDelegate);
    ...
    typedef void (EOS_CALL *EOS_KWS_QueryAgeGate_fn)(EOS_HKWS Handle, const EOS_KWS_QueryAgeGateOptions* Options, void* ClientData, const EOS_KWS_OnQueryAgeGateCallback CompletionDelegate);
    ...
    typedef EOS_EResult (EOS_CALL *EOS_LobbyDetails_CopyAttributeByIndex_fn)(EOS_HLobbyDetails Handle, const EOS_LobbyDetails_CopyAttributeByIndexOptions* Options, EOS_Lobby_Attribute ** OutAttribute);
    typedef EOS_EResult (EOS_CALL *EOS_LobbyDetails_CopyInfo_fn)(EOS_HLobbyDetails Handle, const EOS_LobbyDetails_CopyInfoOptions* Options, EOS_LobbyDetails_Info ** OutLobbyDetailsInfo);
    typedef uint32_t (EOS_CALL *EOS_LobbyDetails_GetAttributeCount_fn)(EOS_HLobbyDetails Handle, const EOS_LobbyDetails_GetAttributeCountOptions* Options);
    typedef EOS_ProductUserId (EOS_CALL *EOS_LobbyDetails_GetMemberByIndex_fn)(EOS_HLobbyDetails Handle, const EOS_LobbyDetails_GetMemberByIndexOptions* Options);
    typedef uint32_t (EOS_CALL *EOS_LobbyDetails_GetMemberCount_fn)(EOS_HLobbyDetails Handle, const EOS_LobbyDetails_GetMemberCountOptions* Options);
    typedef void (EOS_CALL *EOS_LobbyDetails_Info_Release_fn)(EOS_LobbyDetails_Info* LobbyDetailsInfo);
    typedef void (EOS_CALL *EOS_LobbyDetails_Release_fn)(EOS_HLobbyDetails LobbyHandle);
    typedef EOS_EResult (EOS_CALL *EOS_LobbySearch_CopySearchResultByIndex_fn)(EOS_HLobbySearch Handle, const EOS_LobbySearch_CopySearchResultByIndexOptions* Options, EOS_HLobbyDetails* OutLobbyDetailsHandle);
    typedef void (EOS_CALL *EOS_LobbySearch_Find_fn)(EOS_HLobbySearch Handle, const EOS_LobbySearch_FindOptions* Options, void* ClientData, const EOS_LobbySearch_OnFindCallback CompletionDelegate);
    typedef uint32_t (EOS_CALL *EOS_LobbySearch_GetSearchResultCount_fn)(EOS_HLobbySearch Handle, const EOS_LobbySearch_GetSearchResultCountOptions* Options);
    typedef void (EOS_CALL *EOS_LobbySearch_Release_fn)(EOS_HLobbySearch LobbySearchHandle);
    typedef void (EOS_CALL *EOS_Lobby_Attribute_Release_fn)(EOS_Lobby_Attribute* LobbyAttribute);
    typedef EOS_EResult (EOS_CALL *EOS_Lobby_CopyLobbyDetailsHandle_fn)(EOS_HLobby Handle, const EOS_Lobby_CopyLobbyDetailsHandleOptions* Options, EOS_HLobbyDetails* OutLobbyDetailsHandle);
    ...
    typedef EOS_EResult (EOS_CALL *EOS_Lobby_CreateLobbySearch_fn)(EOS_HLobby Handle, const EOS_Lobby_CreateLobbySearchOptions* Options, EOS_HLobbySearch* OutLobbySearchHandle);
    typedef void (EOS_CALL *EOS_Lobby_JoinLobby_fn)(EOS_HLobby Handle, const EOS_Lobby_JoinLobbyOptions* Options, void* ClientData, const EOS_Lobby_OnJoinLobbyCallback CompletionDelegate);
    ...
    typedef EOS_EResult (EOS_CALL *EOS_Metrics_EndPlayerSession_fn)(EOS_HMetrics Handle, const EOS_Metrics_EndPlayerSessionOptions* Options);
    typedef EOS_EResult (EOS_CALL *EOS_Mods_CopyModInfo_fn)(EOS_HMods Handle, const EOS_Mods_CopyModInfoOptions* Options, EOS_Mods_ModInfo ** OutEnumeratedMods);
    typedef void (EOS_CALL *EOS_Mods_EnumerateMods_fn)(EOS_HMods Handle, const EOS_Mods_EnumerateModsOptions* Options, void* ClientData, const EOS_Mods_OnEnumerateModsCallback CompletionDelegate);
    typedef void (EOS_CALL *EOS_Mods_ModInfo_Release_fn)(EOS_Mods_ModInfo* ModInfo);
    ...
    typedef EOS_HPlatform (EOS_CALL *EOS_Platform_Create_fn)(const EOS_Platform_Options* Options);
    ...
    typedef EOS_HCustomInvites (EOS_CALL *EOS_Platform_GetCustomInvitesInterface_fn)(EOS_HPlatform Handle);
    ...
    typedef EOS_HKWS (EOS_CALL *EOS_Platform_GetKWSInterface_fn)(EOS_HPlatform Handle);
    ...
    typedef EOS_HMods (EOS_CALL *EOS_Platform_GetModsInterface_fn)(EOS_HPlatform Handle);
    ...
    typedef EOS_HProgressionSnapshot (EOS_CALL *EOS_Platform_GetProgressionSnapshotInterface_fn)(EOS_HPlatform Handle);
    ...
    typedef EOS_HTitleStorage (EOS_CALL *EOS_Platform_GetTitleStorageInterface_fn)(EOS_HPlatform Handle);
    ...
    typedef void (EOS_CALL *EOS_Platform_Release_fn)(EOS_HPlatform Handle);
    ...
    typedef void (EOS_CALL *EOS_PlayerDataStorageFileTransferRequest_Release_fn)(EOS_HPlayerDataStorageFileTransferRequest PlayerDataStorageFileTransferHandle);
    ...
    typedef EOS_HPlayerDataStorageFileTransferRequest (EOS_CALL *EOS_PlayerDataStorage_ReadFile_fn)(EOS_HPlayerDataStorage Handle, const EOS_PlayerDataStorage_ReadFileOptions* ReadOptions, void* ClientData, const EOS_PlayerDataStorage_OnReadFileCompleteCallback CompletionCallback);
    typedef EOS_HPlayerDataStorageFileTransferRequest (EOS_CALL *EOS_PlayerDataStorage_WriteFile_fn)(EOS_HPlayerDataStorage Handle, const EOS_PlayerDataStorage_WriteFileOptions* WriteOptions, void* ClientData, const EOS_PlayerDataStorage_OnWriteFileCompleteCallback CompletionCallback);
    ...
    typedef EOS_EResult (EOS_CALL *EOS_ProgressionSnapshot_AddProgression_fn)(EOS_HProgressionSnapshot Handle, const EOS_ProgressionSnapshot_AddProgressionOptions* Options);
    typedef EOS_EResult (EOS_CALL *EOS_ProgressionSnapshot_BeginSnapshot_fn)(EOS_HProgressionSnapshot Handle, const EOS_ProgressionSnapshot_BeginSnapshotOptions* Options, uint32_t* OutSnapshotId);
    typedef EOS_EResult (EOS_CALL *EOS_ProgressionSnapshot_EndSnapshot_fn)(EOS_HProgressionSnapshot Handle, const EOS_ProgressionSnapshot_EndSnapshotOptions* Options);
    typedef void (EOS_CALL *EOS_ProgressionSnapshot_SubmitSnapshot_fn)(EOS_HProgressionSnapshot Handle, const EOS_ProgressionSnapshot_SubmitSnapshotOptions* Options, void* ClientData, const EOS_ProgressionSnapshot_OnSubmitSnapshotCallback CompletionDelegate);
    typedef void (EOS_CALL *EOS_RTCAudio_UpdateReceivingVolume_fn)(EOS_HRTCAudio Handle, const EOS_RTCAudio_UpdateReceivingVolumeOptions* Options, void* ClientData, const EOS_RTCAudio_OnUpdateReceivingVolumeCallback CompletionDelegate);
    typedef void (EOS_CALL *EOS_RTCAudio_UpdateSendingVolume_fn)(EOS_HRTCAudio Handle, const EOS_RTCAudio_UpdateSendingVolumeOptions* Options, void* ClientData, const EOS_RTCAudio_OnUpdateSendingVolumeCallback CompletionDelegate);
    typedef EOS_HRTCAudio (EOS_CALL *EOS_RTC_GetAudioInterface_fn)(EOS_HRTC Handle);
    ...
    typedef EOS_EResult (EOS_CALL *EOS_Sanctions_CopyPlayerSanctionByIndex_fn)(EOS_HSanctions Handle, const EOS_Sanctions_CopyPlayerSanctionByIndexOptions* Options, EOS_Sanctions_PlayerSanction ** OutSanction);
    typedef void (EOS_CALL *EOS_Sanctions_CreatePlayerSanctionAppeal_fn)(EOS_HSanctions Handle, const EOS_Sanctions_CreatePlayerSanctionAppealOptions* Options, void* ClientData, const EOS_Sanctions_CreatePlayerSanctionAppealCallback CompletionDelegate);
    typedef uint32_t (EOS_CALL *EOS_Sanctions_GetPlayerSanctionCount_fn)(EOS_HSanctions Handle, const EOS_Sanctions_GetPlayerSanctionCountOptions* Options);
    typedef void (EOS_CALL *EOS_Sanctions_PlayerSanction_Release_fn)(EOS_Sanctions_PlayerSanction* Sanction);
    ...
    typedef void (EOS_CALL *EOS_SessionDetails_Attribute_Release_fn)(EOS_SessionDetails_Attribute* SessionAttribute);
    typedef EOS_EResult (EOS_CALL *EOS_SessionDetails_CopySessionAttributeByIndex_fn)(EOS_HSessionDetails Handle, const EOS_SessionDetails_CopySessionAttributeByIndexOptions* Options, EOS_SessionDetails_Attribute ** OutSessionAttribute);
    typedef uint32_t (EOS_CALL *EOS_SessionDetails_GetSessionAttributeCount_fn)(EOS_HSessionDetails Handle, const EOS_SessionDetails_GetSessionAttributeCountOptions* Options);
    typedef void (EOS_CALL *EOS_SessionDetails_Release_fn)(EOS_HSessionDetails SessionHandle);
    typedef EOS_EResult (EOS_CALL *EOS_SessionModification_AddAttribute_fn)(EOS_HSessionModification Handle, const EOS_SessionModification_AddAttributeOptions* Options);
    ...
    typedef void (EOS_CALL *EOS_Sessions_QueryInvites_fn)(EOS_HSessions Handle, const EOS_Sessions_QueryInvitesOptions* Options, void* ClientData, const EOS_Sessions_OnQueryInvitesCallback CompletionDelegate);
    typedef void (EOS_CALL *EOS_Sessions_RejectInvite_fn)(EOS_HSessions Handle, const EOS_Sessions_RejectInviteOptions* Options, void* ClientData, const EOS_Sessions_OnRejectInviteCallback CompletionDelegate);
    typedef void (EOS_CALL *EOS_Sessions_SendInvite_fn)(EOS_HSessions Handle, const EOS_Sessions_SendInviteOptions* Options, void* ClientData, const EOS_Sessions_OnSendInviteCallback CompletionDelegate);
    ...
    typedef EOS_EResult (EOS_CALL *EOS_Sessions_UpdateSessionModification_fn)(EOS_HSessions Handle, const EOS_Sessions_UpdateSessionModificationOptions* Options, EOS_HSessionModification* OutSessionModificationHandle);
    ...
    typedef void (EOS_CALL *EOS_TitleStorageFileTransferRequest_Release_fn)(EOS_HTitleStorageFileTransferRequest TitleStorageFileTransferHandle);
    typedef EOS_HTitleStorageFileTransferRequest (EOS_CALL *EOS_TitleStorage_ReadFile_fn)(EOS_HTitleStorage Handle, const EOS_TitleStorage_ReadFileOptions* Options, void* ClientData, const EOS_TitleStorage_OnReadFileCompleteCallback CompletionCallback);
    typedef EOS_Bool (EOS_CALL *EOS_UI_GetFriendsVisible_fn)(EOS_HUI Handle, const EOS_UI_GetFriendsVisibleOptions* Options);
    ...
    typedef EOS_Bool (EOS_CALL *EOS_UI_IsSocialOverlayPaused_fn)(EOS_HUI Handle, const EOS_UI_IsSocialOverlayPausedOptions* Options);
    typedef EOS_EResult (EOS_CALL *EOS_UI_PauseSocialOverlay_fn)(EOS_HUI Handle, const EOS_UI_PauseSocialOverlayOptions* Options);
    typedef EOS_EResult (EOS_CALL *EOS_UI_SetDisplayPreference_fn)(EOS_HUI Handle, const EOS_UI_SetDisplayPreferenceOptions* Options);
    ...
    EOS_Achievements_CopyAchievementDefinitionV2ByIndex_fn EOS_Achievements_CopyAchievementDefinitionV2ByIndex = nullptr;
    EOS_Achievements_DefinitionV2_Release_fn EOS_Achievements_DefinitionV2_Release = nullptr;
    EOS_Achievements_GetAchievementDefinitionCount_fn EOS_Achievements_GetAchievementDefinitionCount = nullptr;
    EOS_Achievements_QueryDefinitions_fn EOS_Achievements_QueryDefinitions = nullptr;
    ...
    EOS_Auth_LinkAccount_fn EOS_Auth_LinkAccount = nullptr;
    EOS_Auth_Login_fn EOS_Auth_Login = nullptr;
    EOS_Auth_Logout_fn EOS_Auth_Logout = nullptr;
    EOS_Connect_CreateUser_fn EOS_Connect_CreateUser = nullptr;
    ...
    EOS_CustomInvites_SendCustomInvite_fn EOS_CustomInvites_SendCustomInvite = nullptr;
    EOS_CustomInvites_SetCustomInvite_fn EOS_CustomInvites_SetCustomInvite = nullptr;
    ...
    EOS_Friends_AcceptInvite_fn EOS_Friends_AcceptInvite = nullptr;
    ...
    EOS_Friends_RejectInvite_fn EOS_Friends_RejectInvite = nullptr;
    ...
    EOS_KWS_QueryAgeGate_fn EOS_KWS_QueryAgeGate = nullptr;
    ...
    EOS_LobbyDetails_CopyAttributeByIndex_fn EOS_LobbyDetails_CopyAttributeByIndex = nullptr;
    EOS_LobbyDetails_CopyInfo_fn EOS_LobbyDetails_CopyInfo = nullptr;
    EOS_LobbyDetails_GetAttributeCount_fn EOS_LobbyDetails_GetAttributeCount = nullptr;
    EOS_LobbyDetails_GetMemberByIndex_fn EOS_LobbyDetails_GetMemberByIndex = nullptr;
    EOS_LobbyDetails_GetMemberCount_fn EOS_LobbyDetails_GetMemberCount = nullptr;
    EOS_LobbyDetails_Info_Release_fn EOS_LobbyDetails_Info_Release = nullptr;
    EOS_LobbyDetails_Release_fn EOS_LobbyDetails_Release = nullptr;
    EOS_LobbySearch_CopySearchResultByIndex_fn EOS_LobbySearch_CopySearchResultByIndex = nullptr;
    EOS_LobbySearch_Find_fn EOS_LobbySearch_Find = nullptr;
    EOS_LobbySearch_GetSearchResultCount_fn EOS_LobbySearch_GetSearchResultCount = nullptr;
    EOS_LobbySearch_Release_fn EOS_LobbySearch_Release = nullptr;
    EOS_Lobby_Attribute_Release_fn EOS_Lobby_Attribute_Release = nullptr;
    EOS_Lobby_CopyLobbyDetailsHandle_fn EOS_Lobby_CopyLobbyDetailsHandle = nullptr;
    EOS_Lobby_CreateLobby_fn EOS_Lobby_CreateLobby = nullptr;
    EOS_Lobby_CreateLobbySearch_fn EOS_Lobby_CreateLobbySearch = nullptr;
    EOS_Lobby_JoinLobby_fn EOS_Lobby_JoinLobby = nullptr;
    ...
    EOS_Metrics_EndPlayerSession_fn EOS_Metrics_EndPlayerSession = nullptr;
    EOS_Mods_CopyModInfo_fn EOS_Mods_CopyModInfo = nullptr;
    EOS_Mods_EnumerateMods_fn EOS_Mods_EnumerateMods = nullptr;
    EOS_Mods_ModInfo_Release_fn EOS_Mods_ModInfo_Release = nullptr;
    ...
    EOS_Platform_Create_fn EOS_Platform_Create = nullptr;
    ...
    EOS_Platform_GetCustomInvitesInterface_fn EOS_Platform_GetCustomInvitesInterface = nullptr;
    ...
    EOS_Platform_GetKWSInterface_fn EOS_Platform_GetKWSInterface = nullptr;
    ...
    EOS_Platform_GetModsInterface_fn EOS_Platform_GetModsInterface = nullptr;
    ...
    EOS_Platform_GetProgressionSnapshotInterface_fn EOS_Platform_GetProgressionSnapshotInterface = nullptr;
    ...
    EOS_Platform_GetTitleStorageInterface_fn EOS_Platform_GetTitleStorageInterface = nullptr;
    ...
    EOS_Platform_Release_fn EOS_Platform_Release = nullptr;
    ...
    EOS_PlayerDataStorageFileTransferRequest_Release_fn EOS_PlayerDataStorageFileTransferRequest_Release = nullptr;
    EOS_PlayerDataStorage_QueryFileList_fn EOS_PlayerDataStorage_QueryFileList = nullptr;
    EOS_PlayerDataStorage_ReadFile_fn EOS_PlayerDataStorage_ReadFile = nullptr;
    EOS_PlayerDataStorage_WriteFile_fn EOS_PlayerDataStorage_WriteFile = nullptr;
    ...
    EOS_ProgressionSnapshot_AddProgression_fn EOS_ProgressionSnapshot_AddProgression = nullptr;
    EOS_ProgressionSnapshot_BeginSnapshot_fn EOS_ProgressionSnapshot_BeginSnapshot = nullptr;
    EOS_ProgressionSnapshot_EndSnapshot_fn EOS_ProgressionSnapshot_EndSnapshot = nullptr;
    EOS_ProgressionSnapshot_SubmitSnapshot_fn EOS_ProgressionSnapshot_SubmitSnapshot = nullptr;
    EOS_RTCAudio_UpdateReceivingVolume_fn EOS_RTCAudio_UpdateReceivingVolume = nullptr;
    EOS_RTCAudio_UpdateSendingVolume_fn EOS_RTCAudio_UpdateSendingVolume = nullptr;
    EOS_RTC_GetAudioInterface_fn EOS_RTC_GetAudioInterface = nullptr;
    ...
    EOS_Sanctions_CopyPlayerSanctionByIndex_fn EOS_Sanctions_CopyPlayerSanctionByIndex = nullptr;
    EOS_Sanctions_CreatePlayerSanctionAppeal_fn EOS_Sanctions_CreatePlayerSanctionAppeal = nullptr;
    EOS_Sanctions_GetPlayerSanctionCount_fn EOS_Sanctions_GetPlayerSanctionCount = nullptr;
    EOS_Sanctions_PlayerSanction_Release_fn EOS_Sanctions_PlayerSanction_Release = nullptr;
    EOS_Sanctions_QueryActivePlayerSanctions_fn EOS_Sanctions_QueryActivePlayerSanctions = nullptr;
    EOS_SessionDetails_Attribute_Release_fn EOS_SessionDetails_Attribute_Release = nullptr;
    EOS_SessionDetails_CopySessionAttributeByIndex_fn EOS_SessionDetails_CopySessionAttributeByIndex = nullptr;
    EOS_SessionDetails_GetSessionAttributeCount_fn EOS_SessionDetails_GetSessionAttributeCount = nullptr;
    EOS_SessionDetails_Release_fn EOS_SessionDetails_Release = nullptr;
    EOS_SessionModification_AddAttribute_fn EOS_SessionModification_AddAttribute = nullptr;
    ...
    EOS_Sessions_QueryInvites_fn EOS_Sessions_QueryInvites = nullptr;
    EOS_Sessions_RejectInvite_fn EOS_Sessions_RejectInvite = nullptr;
    EOS_Sessions_SendInvite_fn EOS_Sessions_SendInvite = nullptr;
    EOS_Sessions_UpdateSession_fn EOS_Sessions_UpdateSession = nullptr;
    EOS_Sessions_UpdateSessionModification_fn EOS_Sessions_UpdateSessionModification = nullptr;
    ...
    EOS_TitleStorageFileTransferRequest_Release_fn EOS_TitleStorageFileTransferRequest_Release = nullptr;
    EOS_TitleStorage_ReadFile_fn EOS_TitleStorage_ReadFile = nullptr;
    EOS_UI_GetFriendsVisible_fn EOS_UI_GetFriendsVisible = nullptr;
    EOS_UI_HideFriends_fn EOS_UI_HideFriends = nullptr;
    EOS_UI_IsSocialOverlayPaused_fn EOS_UI_IsSocialOverlayPaused = nullptr;
    EOS_UI_PauseSocialOverlay_fn EOS_UI_PauseSocialOverlay = nullptr;
    EOS_UI_SetDisplayPreference_fn EOS_UI_SetDisplayPreference = nullptr;
