...
godot::Dictionary YugenEOS::connect_create_user(const godot::String &continuance_token) { return connect->connect_create_user(continuance_token); }
...
godot::Dictionary YugenEOS::sessions_create(const godot::String &local_user_id, const godot::String &session_name, int64_t max_players, bool is_public) { return sessions->sessions_create(local_user_id, session_name, max_players, is_public); }
