...
func query_ranks(leaderboard_id: String = "", local_user_id: String = "") -> Dictionary:
	return _call_core("leaderboards_query_ranks", {"leaderboard_id": leaderboard_id, "local_user_id": local_user_id})

func query_user_scores(local_user_id: String = "", stat_name: String = "", target_user_ids: Array = []) -> Dictionary:
	return _call_core("leaderboards_query_scores", {"local_user_id": local_user_id, "stat_name": stat_name, "target_user_ids": target_user_ids})
